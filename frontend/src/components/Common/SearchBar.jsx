...
const SearchBar = () => {
    ...
    return (
        <div className={`flex items-center w-full transition-all duration-100 ${isOpen ? "absolute border-b border-gray-200 top-0 left-0 w-full bg-white h-24 z-50" : "w-auto"}`}>
