    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        <h2 className='text-3xl font-bold mb-6'>Edit Product</h2>
            <form onSubmit={handleSubmit}>
                {/* Name */}
                <div className='mb-6'>
                    <label className='block font-semibold mb2'>Product Name</label>
                    <input type="text"
                     name="name"
                ...
                {/* Description */}
                <div className='mb-6'>
                    <label className='block font-semibold mb2'>Product Description</label>
                ...
                {/* Count IN Stock */}
                <div className='mb-6'>
                    <label className='block font-semibold mb2'>Count in Stock</label>
                    <input type="number"
                     name="countInStock"
                ...
                {/* SKU */}
                <div className='mb-6'>
                    <label className='block font-semibold mb2'>SKU</label>
                    <input type="text"
                     name="sku"
                ...
                {/* Sizes */}
                <div className='mb-6'>
                    <label className='block font-semibold mb2'>Sizes (comma-seperated)</label>
                    <input type="text"
                     name="sizes"
                ...
                {/* Colors */}
                <div className='mb-6'>
                    <label className='block font-semibold mb2'>Colors (comma-seperated)</label>
                    <input type="text"
                     name="colors"
