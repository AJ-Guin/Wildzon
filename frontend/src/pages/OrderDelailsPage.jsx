...
import { Link, useParams } from 'react-router-dom' //this will provide us the id that we pass through the url 

const OrderDelailsPage = () => {
    ...
    <div className='max-w-7xl mx-auto p-4 sm:p-6'>
        ...
        {!orderDetails ? (<p>No Order details found</p>) : (
            <div className='p-4 sm:p-6 rounded-lg border'>
                            ...
                            {orderDetails.orderItems.map((item)=>(
                                <tr key={item.productId} className='border-b'>
                                    <td className='py-2 px-4 flex items-center'>
                                        ...
                                        <Link to={`/product/${item.productId}`} className='text-blue-500 hover:underline cursor-pointer'>{item.name}</Link>
                                    </td>
                ...
                {/* Back To Orders Link */}
                <Link to="/my-orders" className='text-blue-500 hover:underline cursor-pointer'>
...
export default OrderDelailsPage
